...
The _jwt.StandardClaims_ struct contains useful fields like _expiry, issuer name, Subject and etc_. Now we will create some actual claims for the user that just logged in :
